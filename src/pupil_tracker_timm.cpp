...
void Pupil_tracker_timm::update(cv::Mat& eye_cam_frame)
{
	...
	// event handling . TODO: remove from here. really should be in Pupil_tracking
	int c = cv::waitKeyEx(1);
	//if ((char)c == 'q') { break; }
...
void Pupil_tracker_timm::setup_gui()
{
...
Pupil_tracker_timm::options_type Pupil_tracker_timm::decode_genom(Eigen::VectorXf params)
{
...
Pupil_tracker_timm::options_type Pupil_tracker_timm::load_parameters(enum_parameter_settings s)
{
	using namespace EL;
...
Pupil_tracker_timm::params_type Pupil_tracker_timm::set_params(options_type opt)
{
	params_type params;
...
Pupil_tracker_timm::options_type Pupil_tracker_timm::set_options(params_type params)
{
	options_type opt;
...
Eigen::VectorXf Pupil_tracker_timm_tests::eval_fitness(Eigen::VectorXf params, const vector<int>& idx, const int n, const vector<cv::Mat>& images_all, const vector<cv::Point2f>& ground_truth, bool visualize, const int subsampling_width)
{
	using namespace EL;
...
void Pupil_tracker_timm_tests::run_lpw_test_all(enum_simd_variant simd_width)
{
	setup(simd_width);
...
void Pupil_tracker_timm_tests::run_swirski_test(enum_simd_variant simd_width)
{
	setup(simd_width);
...
void Pupil_tracker_timm_tests::run_excuse_test(enum_simd_variant simd_width)
{
	setup(simd_width);
...
void Pupil_tracker_timm_tests::run_differential_evolution_optim(enum_simd_variant simd_width)
{
	setup(simd_width);
